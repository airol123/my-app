...
export default class Tableau extends Component {
  ...
  handleClick=(msgList)=> {
   ...
   renderRow=(props)=> {
    ...
    return (
      ...
      <ListItem selected={this.state.select} button style={style} key={index} onClick={this.state.isRelation==="false"?()=> this.handleClick([this.state.isRelation,this.state.labelSource,this.state.nodes[index-1]]) :()=> this.handleClick([this.state.isRelation,this.state.labelSource,this.state.nodes[index-1],this.state.labelTarget,this.state.relations[index-1].source,this.state.relations[index-1].target,this.state.label])}>
  ...
  render() {
    console.log("tableau",this.state)
    return (
         <div>
      ...
      <Btn labelSource={this.state.labelSource} label={this.state.label} isRalation={this.state.isRelation}></Btn>
      </div>
    </div>
    )
